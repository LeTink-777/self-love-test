...
export async function sendResultEmail({
  ...
  return resend.emails.send({
    ...
    subject,
    html: `
      <div style="font-family: Georgia, 'Times New Roman', serif; max-width: 640px; margin: 0 auto; padding: 40px 20px; color: #1a1a1a;">
        ...
        <p style="font-size: 16px; line-height: 1.6;">Ваш персональный разбор готов. PDF прикреплён к письму — полный текст также продублирован ниже.</p>
        ${resultHtml}
