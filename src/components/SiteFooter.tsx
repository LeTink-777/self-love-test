...
import { BookOpen, FileText, Mail, Send, ShieldCheck } from "lucide-react";
      ...
      <div className="mx-auto w-full max-w-5xl px-5 py-12">
        <div className="grid gap-10 sm:grid-cols-2">
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            <div>
              <p className="text-xs uppercase tracking-widest text-muted">Разделы</p>
        ...
        <div className="mt-10 border-t border-line pt-6 text-xs leading-relaxed text-muted">
          ...
          <p className="mt-1">
            Оплата через ЮKassa. Все подключённые способы оплаты — карты, СБП,
            ЮMoney, рассрочка — доступны на странице оплаты.
          </p>
        </div>
      </div>
    </footer>
